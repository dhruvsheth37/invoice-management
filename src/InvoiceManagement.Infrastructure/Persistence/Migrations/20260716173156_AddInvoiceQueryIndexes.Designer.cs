...
namespace InvoiceManagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260716173156_AddInvoiceQueryIndexes")]
    partial class AddInvoiceQueryIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InvoiceManagement.Domain.Invoices.Invoice", b =>
                {
                    ...
                    b.HasIndex("TenantId", "IsActive", "CreatedUtc", "Id")
                        .IsDescending(false, false, true, true);

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "IsActive", "CreatedUtc", "Id"), new[] { "InvoiceNumber", "Status", "CustomerId", "CurrencyCode", "Total", "IssueDate", "DueDate" });

                    b.HasIndex("TenantId", "IsActive", "CustomerId", "CreatedUtc")
                        .IsDescending(false, false, false, true);

                    b.HasIndex("TenantId", "IsActive", "DueDate", "Id");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "IsActive", "DueDate", "Id"), new[] { "InvoiceNumber", "Status", "CustomerId", "CurrencyCode", "Total", "IssueDate", "CreatedUtc" });
                    ...
                    b.HasIndex("TenantId", "IsActive", "Total", "Id");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "IsActive", "Total", "Id"), new[] { "InvoiceNumber", "Status", "CustomerId", "CurrencyCode", "IssueDate", "DueDate", "CreatedUtc" });

                    b.HasIndex("TenantId", "IsActive", "CurrencyCode", "Status", "DueDate");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "IsActive", "CurrencyCode", "Status", "DueDate"), new[] { "Total" });
